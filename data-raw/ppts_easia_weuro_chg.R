...
# ppts_easia_weuro_sel <- ppts_easia_weuro %>%
...
write_csv(ppts_easia_weuro_world_pchg_raw, "data-raw/ppts_easia_weuro_world_pchg_raw.csv")
...
write_csv(ppts_easia_weuro_world_pchg_interp1, "data-raw/ppts_easia_weuro_world_pchg_interp1.csv")
