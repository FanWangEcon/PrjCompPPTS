...
We use the interpolated annual percentage changes to fill in gaps in levels. We interpolate with this function: [ff_ppts_interp_linear](https://fanwangecon.github.io/PrjCompPPTS/reference/ff_ppts_interp_linear.html). We test out the contents of the function via scripts below, and then confirm that the script and the function produce the same result. We first proceed with the script, and then the function. 
